...
<html>
   ...
   <div class="register_content_div" id="register_content">
       <div class="register_left">
           <form id="register_form" name="register_form_name" method="post">
               ...
               <p class="register_form_item form_item_password">
                   <label class="form_user_label form_item_user_password_label">
                       密码
                   </label>
                   <!--密码input框-->
                   <input name="form_user_password_input_name" id="form_user_password_input_id" class="form_user_input form_user_password_input" type="password" placeholder="请设置登陆密码">
               </p>
   ...
   */
   ...
   $(".form_user_phone_input").focus(function () {
       ...
       $(".form_user_phone_success_notice_span").css("display","none");
   }).blur(function () {
       ...
       if(chEnWordCount($(".form_user_phone_input").val())>0){
          ...
          if(checkMobile()===false){
              ...
              $(".form_user_phone_error_notice_span").css("display","none");
              $(".form_user_phone_success_notice_span").css("display","block");
          }
       }
